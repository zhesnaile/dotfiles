...
local theme_path = string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "uwu")
...
globalkeys = gears.table.join(
   ...
   awful.key({}, "XF86AudioPlay", function()
     ...
     {description = "play/pause music", group = "media keys"}),
   awful.key({}, "XF86AudioNext", function()
     awful.util.spawn("playerctl next", false) end,
     {description = "play next track", group="media keys"}),
   awful.key({}, "XF86AudioPrev", function()
     awful.util.spawn("playerctl previous", false) end,
     {description = "play previous track", group="media keys"}),
...
-- Run garbage collector regulary to prevent memory leaks
gears.timer {
       timeout = 30,
       autostart = true,
