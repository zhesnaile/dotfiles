...
--
local theme_path = string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "goo")
...
clientbuttons = RC.keys.clientbuttons
clientkeys = RC.keys.clientkeys
root.keys(RC.keys.globalkeys)
